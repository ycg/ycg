...
namespace Ycg.Data.Oracle
{
    public class OracleHelper : DataBase, IDBHelper
    {
        ...
        {
            return this.ExecuteNonQuery(transaction, commandText, CommandType.Text, null);
        }
        ...
        #region ExecuteScalerForGeneric
        ...
        #region ExecuteXmlReader - No Implement
        ...
        #region Async Execute - No Implement
        ...
        #region Update DataSet - No Implement
