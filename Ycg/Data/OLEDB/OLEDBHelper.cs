...
namespace Ycg.Data.OLEDB
{
    public class OLEDBHelper : DataBase, IDBHelper
    {
        ...
        public bool ExecuteNonQuery(DbTransaction transaction, string commandText, CommandType commandType, params IDataParameter[] parameters)
        {
            ...
            {
                command.Transaction = transaction as OleDbTransaction;
        ...
        #region ExecuteScalar For Generic
        ...
        {
            return this.ExecuteScalar<T>(commandText, commandType);
        }
        ...
        #region Async Execute - Not Implement
        ...
        public IAsyncResult BeginExecuteNonQuery(string commandText, System.Data.CommandType commandType, AsyncCallback asyncCallback, object state)
        {
            throw new NotImplementedException();
        }

        public IAsyncResult BeginExecuteNonQuery(string commandText, System.Data.CommandType commandType, AsyncCallback asyncCallback, object state, params System.Data.IDataParameter[] parameters)
        {
            throw new NotImplementedException();
        }
        ...
        public IAsyncResult BeginExecuteReader(string commandText, System.Data.CommandType commandType, AsyncCallback asyncCallback, object state)
        {
            throw new NotImplementedException();
        }

        public IAsyncResult BeginExecuteReader(string commandText, System.Data.CommandType commandType, AsyncCallback asyncCallback, object state, params System.Data.IDataParameter[] parameters)
        {
            throw new NotImplementedException();
        }
        ...
        public IAsyncResult BeginExecuteXmlReader(string commandText, System.Data.CommandType commandType, AsyncCallback asyncCallback, object state)
        {
            throw new NotImplementedException();
        }

        public IAsyncResult BeginExecuteXmlReader(string commandText, System.Data.CommandType commandType, AsyncCallback asyncCallback, object state, params System.Data.IDataParameter[] parameters)
        {
            throw new NotImplementedException();
        }
